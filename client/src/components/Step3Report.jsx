    ...
    return (
        ...
        <div className='min-h-screen bg-gradient-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
            ...
            <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
                ...
                <button
                    onClick={downloadPDF}
                    className="bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base"
                >
                    Download PDF
                </button>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
                ...
                <div className='space-y-6'>
                    ...
                    >
                        ...
                        <div className="text-base sm:text-lg font-semibold text-gray-700 mb-6">
                            Skill Evaluation
                        </div>
